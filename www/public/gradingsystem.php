...
<div class="main-wrapper">
    ...
    <main class="content-area">
        ...
        <?php
        // Grade system data structure
        $gradeSystem = [
            'sections' => [
                [
                    'title' => 'Preliminary Grade (Weight = 30%)',
                    'items' => [
                ...
                [
                    'title' => 'Mid-Term Grade (Weight = 30%)',
                    'items' => [
                ...
                [
                    'title' => 'Pre-Final Grade (Weight = 40%)',
                    'items' => [
                        'Class Standing = 60% (Quizzes, recitations, assignments, reports, term papers, practice sets, book reports and attendance)',
            ...
            'finalGradeDistribution' => [
                'Transmuted Prelim Exam Grade' => '30%',
                'Transmuted Mid-Term Exam Grade' => '30%',
                'Transmuted Pre-Final Exam Grade' => '40%',
                'Final Computed Grade' => '100%'
            ]
        ];
        ?>
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <?php foreach ($gradeSystem['sections'] as $section): ?>
                    <div class="grade-section">
                        <div class="grade-title">
                            <i class="bi bi-bookmark-fill me-2"></i><?php echo $section['title']; ?>
                        </div>
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table table-striped align-middle">
                        ...
                        <tbody>
                            <?php foreach ($gradeSystem['finalGradeDistribution'] as $grade => $percentage): ?>
                                <tr <?php echo $grade === 'Final Computed Grade' ? 'class="table-warning fw-bold"' : ''; ?>>
                                    <td><?php echo $grade; ?></td>
                                    <td class="text-end fw-bold"><?php echo $percentage; ?></td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>
